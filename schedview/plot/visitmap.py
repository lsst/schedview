...
BAND_COLORS = dict(u='#56b4e9', g='#008060', r='#ff4000', i='#850000', z='#6600cc', y='#000000')
...
def plot_visit_skymaps(visits, footprint, conditions):
    ...
    for band in 'ugrizy':
        ...
        visit_ds = asphere.add_marker(
            ...
            circle_kwargs={"fill_alpha": "in_mjd_window", "fill_color": BAND_COLORS[band], 'line_alpha': 0},
        )
...
def create_visit_skymaps(visits, scheduler, night_date, observatory=None, timezone="Chile/Continental"):
