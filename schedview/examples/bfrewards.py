...
def make_basis_function_reward_plot(
    iso_date: str | datetime.date,
    reward_source: str,
    report: None | str = None,
) -> bokeh.models.UIElement:
    """Make a visualization showing rewards by basis function.
    ...
    # Plot
    maybe_result = schedview.plot.rewards.nested_tier_reward_timeline_plot(
        rewards_df, schedview.plot.rewards.reward_timeline_for_tier, day_obs.mjd
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="bfrewards", description="Create a visualization showing rewards by basis function."
    )
    ...
    make_basis_function_reward_plot(args.date, args.rewards_source, args.report)
