...
**Document Number:** RTN-XXX
**Title:** Timeline Builder (tlbuilder) - A New API for Nightly Timeline Visualization
**Abbreviation:** tlbuilder

## Document overview

This Concept of Operations (ConOps) document describes the Timeline Builder (tlbuilder) system, a new implementation of the timeline visualization functionality in the `schedview` library for the Rubin Observatory LSST scheduler. This document is intended for users, developers, and project stakeholders who need to understand the requirements, motivations, and operational concepts for this new timeline visualization system.
